...
def category_sort(message):
    category = {
        constants_bot.TA_CHANNEL_ID: Category.TIMEATTACK,
        constants_bot.MC_CHANNEL_ID: Category.MILDCORE,
        constants_bot.HC_CHANNEL_ID: Category.HARDCORE,
        constants_bot.BONUS_CHANNEL_ID: Category.BONUS,
    }
    return category.get(message.channel.id, Category.OTHER)
...
#
#         embed = doom_embed(
#             title=username.name if username else "Unknown",
